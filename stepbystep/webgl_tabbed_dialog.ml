...
(* Function to update the webgl_tabbed_dialog.ml init function *)
let init () =
  let open Tyxml_js.Html in
  ...
  (* Initialize with step-by-step tab active *)
  select_tab "step-tab"
